...
function transformProps(chartProps) {
  ...
  const numberFormatter = (0, _core.getNumberFormatter)(numberFormat); // TODO: remove cast once metrics is cleaned up in QueryFormData

  const metrics = formDataMetrics.map(metric => (0, _core.convertMetric)(metric).label);
